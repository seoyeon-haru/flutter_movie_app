...
class TopRatedList extends ConsumerWidget {
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              final movie = result.topRated[index];
              return ClipRRect(
                borderRadius: BorderRadius.circular(10),
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder:(context) {
                      return DetailPage(heroTag: '평점높은순-$index',id: movie.id, posterPath: movie.posterPath);
                    },));
                  },
                  child: Hero(
                    tag: '평점높은순-$index',
            ...
            itemCount: result.topRated.length,
          ),
        ),
      ],
    );
